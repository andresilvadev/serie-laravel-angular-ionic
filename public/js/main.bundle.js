...
module.exports = "<div class=\"row\">\n    <div class=\"col-md-12\">\n      <h1>\n          Novo álbuns\n      </h1>\n    </div>\n    <div class=\"col-md-12\">\n      <div class=\"form-group\">\n        <label for=\"name\">Nome</label>\n        <input type=\"text\" id=\"name\" class=\"form-control\" [(ngModel)]=\"name\" autocomplete=\"off\">\n      </div>\n      <button class=\"btn btn-primary\" (click)=\"create()\">Criar álbum</button>\n    </div>\n</div>\n"
...
var AlbumCreateComponent = /** @class */ (function () {
    ...
    AlbumCreateComponent.prototype.create = function () {
        var _this = this;
        this.http.post('http://127.0.0.1:8000/api/albums', { name: this.name })
...
module.exports = "<div class=\"row\">\n  <div class=\"col-md-12\">\n    <h1>\n        Meus álbuns\n    </h1>\n  </div>\n  <div class=\"col-md-12\">\n    <button class=\"btn btn-primary\" [routerLink]=\"['create']\">Novo álbum</button>\n  </div>\n</div>\n<br>\n<div class=\"row\">\n    <div class=\"card col-md-3\" *ngFor=\"let album of albums\">\n      <div class=\"card-body\">\n        <h5 class=\"card-title\">{{ album.name }}</h5>\n      </div>\n    </div>\n</div>\n\n"
...
var AlbumListComponent = /** @class */ (function () {
    ...
    AlbumListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('http://127.0.0.1:8000/api/albums')
            .subscribe(function (data) {
            _this.albums = data;
...
var routes = [
    ...
    { path: 'photo/create', component: __WEBPACK_IMPORTED_MODULE_5__photo_create_photo_create_component__["a" /* PhotoCreateComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__angular_router__["b" /* RouterModule */].forRoot(routes, { useHash: true }),
